...
export default class ReactGridLayout extends React.Component<Props, State> {
  ...
  placeholder(): ?ReactElement<any> {
    ...
    let shadowChild = this.props.children.find(child => child.key === activeDrag.i);
    return this.processGridItem(shadowChild,true);
   ...
   * @param  {Boolean} placeholder if render placeholder
   * @return {Element}       Element wrapped in draggable and properly placed.
   */
  processGridItem(child: ReactElement<any>,placeholder: Boolean): ?ReactElement<any> {
